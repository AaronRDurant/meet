...
// Credentials are values required to get access to your calendar. process.env means the value is in the config.json file. This is best practice because it keeps your API secrets hidden.
const credentials = {
  ...
  redirect_uris: ["https://AaronRDurant.github.io/meet/"],
  javascript_origins: ["https://AaronRDurant.github.io", "http://localhost:3000"],
};
...
// First step of OAuth process: Generate a URL so users can log in with Google and be authorized to see your calendar. After logging in, they'll receive a code as a URL parameter.
